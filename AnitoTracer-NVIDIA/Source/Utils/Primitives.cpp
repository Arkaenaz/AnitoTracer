																	 ...
																	 const glm::vec3& positionOffset)
{
    ...
    for (int i = 0; i < horizontalSegments; i++) {
        ...
        glm::vec3 position = glm::vec3(0, -1, 0) * radius + positionOffset;  // Apply position offset
        Structs::VertexPositionNormalTangentTexture vertex(position,
                                                           glm::vec3(0, -1, 0),
                                                           glm::vec3(0),
                                                           glm::vec2(u, v));
    ...
    for (int i = 0; i < verticalSegments - 1; i++) {
        ...
        for (int j = 0; j <= horizontalSegments; j++) {
            ...
            glm::vec3 position = normal * radius + positionOffset;  // Apply position offset
            Structs::VertexPositionNormalTangentTexture vertex(position, normal, glm::vec3(0), texCoord);
